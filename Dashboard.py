        ...
        if multiplos is not None and not multiplos.empty:
            ...
            with col9:
                ...
                <div class='metric-box'>
                    ...
                    ([(Ativo circulante + Ativo Não Circulante) - Passivo Não Financeiro]/Ativo Total).'>Endividamento Total</div>
                </div>
                """, unsafe_allow_html=True)
            ...
            with col10:
                ...
                <div class='metric-box'>
                    ...
                    ([(Ativo circulante + Ativo Não Circulante] - Passivo Não Financeiro]/Patrimônio Líquido).'>Alavancagem Financeira</div>
                </div>
                """, unsafe_allow_html=True)
