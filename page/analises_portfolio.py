...
def render() -> None:
    ...
    st.markdown(
        ...
        <style>
          ...
          .p6-focus-wrap{margin:8px 0 14px 0}
          .p6-focus-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px}
          .p6-focus-card{border-radius:16px;padding:14px 14px 12px 14px;border:1px solid rgba(255,255,255,.12);box-shadow:0 10px 24px rgba(0,0,0,.16)}
          .p6-focus-card h4{margin:0 0 6px 0;font-size:12px;letter-spacing:.3px;opacity:.84;text-transform:uppercase}
          .p6-focus-card .main{font-size:18px;font-weight:900;line-height:1.15}
          .p6-focus-card .sub{margin-top:6px;font-size:12px;opacity:.76;line-height:1.3}
          .p6-focus-neutral{background:linear-gradient(180deg, rgba(59,130,246,.12), rgba(59,130,246,.05));border-color:rgba(59,130,246,.28)}
          .p6-focus-good{background:linear-gradient(180deg, rgba(34,197,94,.12), rgba(34,197,94,.05));border-color:rgba(34,197,94,.28)}
          .p6-focus-warn{background:linear-gradient(180deg, rgba(234,179,8,.12), rgba(234,179,8,.05));border-color:rgba(234,179,8,.28)}
          .p6-focus-bad{background:linear-gradient(180deg, rgba(239,68,68,.12), rgba(239,68,68,.05));border-color:rgba(239,68,68,.28)}
    ...
    def _call_llm(client: Any, prompt: str) -> str:
        ...
        model = AIConfig().model  # fonte única: AI_MODEL env var via AIConfig
