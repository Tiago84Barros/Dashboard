...
# Version: patch6_rich_v4_with_patch7
...
def _normalize_final_report(data: dict, ticker: str, topic_summaries: Dict[str, dict]) -> dict:
    ...
    try:
        out["score_qualitativo"] = int(out.get("score_qualitativo", 50))
    except Exception:
    ...
    out.setdefault("schema_version", "patch6_rich_v4_with_patch7")
...
def build_rich_report_json(
    *,
    ...
    # Enriquecimento com detector estratégico (Patch7)
    final = enrich_patch6_result(final)
